...
function AIMobileCalendar() {
  ...
  return (
    <div className="max-w-md mx-auto min-h-screen" style={{ backgroundColor, color: textColor }}>
      <div className="px-6 py-6 border-b border-gray-300" style={{
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-2xl font-black tracking-wide" style={{ color: textColor }}>CALENDAR</h1>
          </div>
          <Settings
      ...
      <div className="flex items-center justify-between px-6 py-6 border-b border-gray-300" style={{
        ...
        >
          <ChevronLeft className="w-6 h-6" style={{ color: backgroundColor }} />
        </button>
        <h2 className="text-3xl font-black uppercase tracking-wider" style={{
        ...
        <button
          ...
          className="p-3 hover:opacity-70 rounded-full transition-opacity"
        >
          <ChevronRight className="w-6 h-6" style={{ color: backgroundColor }} />
        </button>
      </div>

      <div className="flex mx-6 my-6 rounded-2xl p-2 border border-gray-300" style={{ backgroundColor }}>
      ...
      <div className="flex-1 overflow-auto" style={{ backgroundColor }}>
        {viewMode === 'month' && (
          <>
            <div className="grid grid-cols-7 border-b border-gray-300" style={{
              backgroundColor: backgroundColor === '#ffffff' ? '#f5f5f5' : backgroundColor
            }}>
              {weekDays.map(day => (
                <div key={day} className="p-4 text-center text-sm font-bold uppercase tracking-widest" style={{ color: textColor }}>
                  {day}
                </div>
              ))}
            </div>

            <div className="grid grid-cols-7" style={{ backgroundColor }}>
              {days.map((day, index) => {
                ...
                return (
                  <div key={index} className="border-b border-r border-gray-300 min-h-[100px] p-3 hover:opacity-70 transition-opacity">
                    {day && (
                      <>
                        <div
        ...
        {viewMode === 'week' && (
          <div className="flex flex-col" style={{ backgroundColor }}>
            <div className="grid grid-cols-8 border-b border-gray-300" style={{
              backgroundColor: backgroundColor === '#ffffff' ? '#f5f5f5' : backgroundColor
            }}>
              ...
              {getWeekDays(currentDate).map((day, index) => {
                ...
                return (
                  <div key={index} className="p-4 text-center">
                    <div className="text-xs font-bold uppercase tracking-widest" style={{ color: textColor }}>
            ...
            <div className="flex-1">
              {getHoursArray().map(hour => (
                <div key={hour} className="grid grid-cols-8 border-b border-gray-300 min-h-[70px] hover:opacity-70 transition-opacity">
                  <div className="p-3 text-sm font-bold border-r border-gray-300" style={{ color: textColor }}>
                    {formatTime(hour)}
                  </div>
                  {getWeekDays(currentDate).map((day, dayIndex) => {
                    ...
                    return (
                      <div key={dayIndex} className="border-r border-gray-300 p-2">
                        {dayEvents.map(event => (
                          <div
                            key={event.id}
                            onClick={() => openEditModal(event)}
        ...
        {viewMode === 'day' && (
          <div className="flex flex-col" style={{ backgroundColor }}>
            <div className="p-6 border-b border-gray-300" style={{
              backgroundColor: backgroundColor === '#ffffff' ? '#f5f5f5' : backgroundColor
            }}>
              <div className="text-center">
                <div className="text-sm font-bold uppercase tracking-widest" style={{ color: textColor }}>
                  {currentDate.toLocaleDateString('en-US', { weekday: 'short' }).toUpperCase()}
                </div>
                <div className="text-6xl font-black mt-2" style={{ fontStretch: 'condensed', color: textColor }}>
                  {currentDate.getDate()}
                </div>
            ...
            <div className="flex-1">
              {getHoursArray().map(hour => {
                ...
                return (
                  <div key={hour} className="flex border-b border-gray-300 min-h-[90px] hover:opacity-70 transition-opacity">
                    <div className="w-24 p-4 text-sm font-bold border-r border-gray-300" style={{ color: textColor }}>
                      {formatTime(hour)}
                    </div>
                    <div className="flex-1 p-3">
                      {hourEvents.map(event => (
                        <div
                          ...
                          style={{ backgroundColor: event.color }}
                        >
                          <div className="font-black text-lg">{event.title}</div>
      ...
      {showSettings && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-6">
          <div className="bg-white w-full max-w-sm rounded-2xl p-6 space-y-6 border border-gray-300">
            <div className="flex items-center justify-between">
              <h3 className="text-xl font-black text-black uppercase tracking-wider">Settings</h3>
              <button
            ...
            <div className="space-y-4">
              <h4 className="text-lg font-bold text-black uppercase tracking-wide">Theme</h4>
              <div className="flex items-center justify-between">
            ...
            <div className="space-y-4">
              <h4 className="text-lg font-bold text-black uppercase tracking-wide">Categories</h4>
      ...
      {editingEvent && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-6">
          <div className="bg-white w-full max-w-sm rounded-2xl p-6 space-y-4 border border-gray-300">
            <div className="flex items-center justify-between">
              <h3 className="text-xl font-black text-black uppercase tracking-wider">Edit Event</h3>
              <button
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-bold text-black mb-2 uppercase tracking-wide">Title</label>
                <input
                  type="text"
                  value={editTitle}
              ...
              <div>
                <label className="block text-sm font-bold text-black mb-2 uppercase tracking-wide">Time</label>
                <input
                  type="time"
                  value={editTime}
              ...
              <div>
                <label className="block text-sm font-bold text-black mb-2 uppercase tracking-wide">Category</label>
                <select
                  value={editCategory}
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 rounded-full shadow-lg flex items-center justify-center transition-all transform
        hover:scale-105"
      ...
      {showInput && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end z-50">
          <div className="bg-white w-full rounded-t-2xl p-6 space-y-4 border-t border-gray-300">
            <div className="flex items-center justify-between">
              <h3 className="text-xl font-black text-black uppercase tracking-wider">Add Event</h3>
              <button
            ...
            <div className="space-y-3">
              ...
              <div className="flex space-x-2">
                ...
                />
                <button className="p-4 bg-gray-200 hover:bg-gray-300 rounded-xl transition-colors border border-gray-400">
      ...
      <div className="px-6 py-4 border-t border-gray-300" style={{
        backgroundColor: backgroundColor === '#ffffff' ? '#f5f5f5' : backgroundColor
      }}>
          ...
          {Object.entries(categories).map(([category, color]) => (
            <div key={category} className="flex items-center space-x-2">
              <div
                ...
                style={{ backgroundColor: color }}
              ></div>
              <span className="text-sm font-bold uppercase tracking-wide" style={{ color: textColor }}>{category}</span>
            </div>
          ))}
        </div>
      </div>
...
ReactDOM.render(<AIMobileCalendar />, document.getElementById('root'));